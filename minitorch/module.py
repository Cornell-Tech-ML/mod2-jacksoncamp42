...
class Module:
    ...
    def named_parameters(self) -> Sequence[Tuple[str, Parameter]]:
        ...
        for module_name, module in self._modules.items():
            ...
            parameters.extend(
                (f"{module_name}.{name}", param) for name, param in child_params
            )
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        ...
        This method allows the object to be called like a function. It delegates
        the call to the `forward` method.
        ...
        Returns:
        -------
            The result of calling the `forward` method.
